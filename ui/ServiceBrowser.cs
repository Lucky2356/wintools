...
namespace Wintools {
    internal sealed partial class MainWindow {
        ...
        private void InitializeServiceBrowser(){
            ...
            serviceMode=new ComboBox{Width=205,ItemsSource=new[]{"Все способы запуска","Автоматический запуск","Ручной запуск","Запуск отключён","Есть действие в каталоге"},SelectedIndex=0};System.Windows.Automation.AutomationProperties.SetName(serviceMode,"Фильтр служб");serviceMode.SelectionChanged+=(s,e)=>FilterServices();filters.Children.Add(serviceMode);InitializeServiceWatching(filters);
