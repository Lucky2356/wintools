...
namespace Wintools {
    internal static class SelfTests {
        ...
        internal static int Run() {
            ...
            StartupIntegrationTests.Run();IntegrityIntegrationTests.Run();PowerIntegrationTests.Run();ServiceManagementTests.Run();ApplicationRegistryTests.Run();UpdateTests().GetAwaiter().GetResult();
