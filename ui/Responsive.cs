...
namespace Wintools {
    internal sealed partial class MainWindow {
        ...
        private void AdaptLayout(){
            ...
            string[] labels={"Каталог действий","История и откат","Подборки","Настройки","План изменений","Службы сейчас","Диагностика ПК","Сверить настройки","Ускорение Windows","Приложения","Проверка сети","Обслуживание"};
