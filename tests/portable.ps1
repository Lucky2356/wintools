...
foreach($name in @('portable-ui.png','portable-ui-light.png','portable-ui-settings-dark.png','portable-ui-settings-light.png','portable-ui-compact.png','portable-ui-updates.png','portable-ui-collections.png','portable-ui-browse.png','portable-ui-plan.png','portable-ui-health-5.png','portable-ui-health-6.png','portable-ui-health-7.png','portable-ui-health-8.png','portable-ui-service-cards.png')){
