...
function Run-Portable($path,$arguments,$expected=0){
  ...
  if(-not $process.WaitForExit($timeout)){throw 'Portable test timed out'}
...
foreach($name in @('portable-ui.png','portable-ui-light.png','portable-ui-settings-dark.png','portable-ui-settings-light.png','portable-ui-compact.png','portable-ui-updates.png','portable-ui-collections.png','portable-ui-browse.png','portable-ui-plan.png','portable-ui-health-5.png','portable-ui-health-6.png','portable-ui-health-7.png','portable-ui-health-8.png','portable-ui-service-cards.png','portable-ui-wide-2.png','portable-ui-wide-3.png','portable-ui-wide-5.png','portable-ui-monitor.png','portable-ui-applications.png','portable-ui-applications-compact.png','portable-ui-network.png','portable-ui-service-management.png','portable-ui-service-management-compact.png','portable-ui-service-watch.png','portable-ui-power.png','portable-ui-power-compact.png','portable-ui-integrity.png','portable-ui-integrity-compact.png','portable-ui-startup.png','portable-ui-startup-compact.png','portable-ui-repair.png','portable-ui-repair-compact.png')){
